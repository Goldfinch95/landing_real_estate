...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1A1A18] text-white">
      {/* Main footer grid */}
      <div className="px-6 md:px-10 lg:px-16 py-14 md:py-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-8">
        ...
        {/* Column 3: Newsletter — spans full width on sm to avoid orphan */}
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex border border-white/20 hover:border-white/40 transition-colors">
              <input
                ...
                placeholder="Email..."
                className="flex-1 px-4 py-3 bg-transparent font-sans text-sm text-white placeholder:text-white/30 outline-none min-w-0"
              />
              <button
                type="submit"
                className="px-4 text-white/30 hover:text-white transition-colors flex-shrink-0"
      ...
      {/* Bottom bar */}
      <div className="border-t border-white/10 px-6 md:px-10 lg:px-16 py-5 flex justify-center">
